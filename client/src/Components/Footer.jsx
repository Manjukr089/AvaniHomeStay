...
function Footer() {
    return (
        <footer className="border-top bg-white mt-5">
            ...
            <div className="bg-success text-blue d-flex d-row justify-content-around align-items-center flex-wrap" style={{backgroundImage: "linear-gradient(to right, #98FB98, #00BFFF)"}}>
                <div>
                    <p className="text-center pt-3">&copy; 2024 Avani Home Stay. All Right Reserved</p>
                </div>
                {/* <div>
